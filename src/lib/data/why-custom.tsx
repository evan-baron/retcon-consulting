...
export const ReasonTiles: ReasonTile[] = [
	...
	},
	{
		...
		icon: <AutoFixHigh className={styles.icon} />,
	},
	{
		title: 'Scalability &\nFuture-Proofing',
		summary:
	...
	},
	{
		...
		stat2:
			'90% of hacked CMS sites in 2022 were running WordPress, mostly due to plugin vulnerabilities.',
		icon: <Security className={styles.icon} />,
	},
	{
		title: 'Ownership &\nControl',
		summary:
		...
		icon: <LockOpen className={styles.icon} />,
	},
	{
		title: 'Cost vs. Value',
		summary:
		...
		icon: <AttachMoney className={styles.icon} />,
	},
	{
		title: 'Mobile-First\nExperience',
		summary:
		...
		icon: <Phonelink className={styles.icon} />,
	},
	{
		...
		icon: <StarBorder className={styles.icon} />,
	},
];
