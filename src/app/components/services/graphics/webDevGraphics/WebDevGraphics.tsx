			...
			<div className={styles.development}>
				...
				<div className={styles.tablet}>
					<div className={styles.screen}>
						<div className={styles.navbar}>
							<div className={styles.logo}>
								<Image src='/logo.svg' alt='Logo Image' width={9} height={9} />
							</div>
							<div className={styles.brand}>Retcon Consulting</div>
							<div className={styles.burger}>
								<div className={styles.line}></div>
				...
				<div className={styles.mobile}>
					<div className={styles.screen}>
						<div className={styles.navbar}>
							<div className={styles.logo}>
								<Image src='/logo.svg' alt='Logo Image' width={8} height={8} />
							</div>
							<div className={styles.brand}>Retcon Consulting</div>
							<div className={styles.burger}>
								<div className={styles.line}></div>
					...
					<div className={styles.palette3}>
						{Array.from({ length: 5 }).map((_, index) => (
							<div
								...
								className={styles.pantone}
								style={{
									backgroundColor: `hsl(var(--hue), 100%, ${80 - index * 15}%)`,
								}}
							></div>
						))}
					</div>
